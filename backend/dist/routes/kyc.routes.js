...
router.post('/upload', auth_middleware_1.authMiddleware, upload.single('file'), (0, kyc_validator_1.validateFile)(kyc_validator_1.kycUploadSchema), kycController.uploadKycFile);
